...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You are receiving this email from the online shope because of the successfull purchase.</p>
...
<tr> Surname : {{ $order['Surname'] }} </tr>
<tr> Name : {{ $order['Firstname'] }} </tr>
<tr> Email : {{ $order['Email'] }} </tr>
<tr> Total Amount : {{ $order['total'] }}$ </tr>
